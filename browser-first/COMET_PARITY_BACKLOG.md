...
- Archived packaged-app diagnostics: prior app-bundle launch diagnostics are outside the 2.0.0 alpha. The alpha readiness gate is the Chrome extension plus local Node bridge.

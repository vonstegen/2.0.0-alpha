...
| `docs/architecture/ADR-026-minimal-kernel-replaceable-default-addons.md` | minimal kernel, replaceable primary agent/chat/memory, Core Engineer | ratify Augmentor as native recommended orchestrator without making it an irreplaceable policy authority |

...
| Extract generic start/status/events/cancel/artifact | `in-progress` | Phase 1 doc [`CP4-LIFECYCLE-EXTRACTION-MIGRATION.md`](CP4-LIFECYCLE-EXTRACTION-MIGRATION.md) + Phase 2 [`hermes-provider-adapter.ts`](../../../src/sdk/harnesses/hermes-provider-adapter.ts) (17 parity tests) + Phase 3 [`opencode-provider-adapter.ts`](../../../src/sdk/harnesses/opencode-provider-adapter.ts) (18 parity tests, `finish-atomic` cancel, workspace-root enforcement, JSON-stream CLI parsing) + [`openclaw-provider-adapter.ts`](../../../src/sdk/harnesses/openclaw-provider-adapter.ts) (11 parity tests, `quarantine` cancel + forensic-survival, gateway child enumeration) + [`agentzero-provider-adapter.ts`](../../../src/sdk/harnesses/agentzero-provider-adapter.ts) (10 parity tests, `cancel` + `docker kill` lifecycle, single container-agent child) + [`deepseek-provider-adapter.ts`](../../../src/sdk/harnesses/deepseek-provider-adapter.ts) (12 parity tests, OpenAI-compatible HTTP delegation, single cloud-inference child); conformance suite still passes for all 8 reference providers; `engineer:verify` gate green; 1197 browser-first extension tests still pass |

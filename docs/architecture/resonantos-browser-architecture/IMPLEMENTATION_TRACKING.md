...
| Extract generic start/status/events/cancel/artifact | `in-progress` | Phase 1 doc [`CP4-LIFECYCLE-EXTRACTION-MIGRATION.md`](CP4-LIFECYCLE-EXTRACTION-MIGRATION.md) + Phase 2 [`src/sdk/harnesses/hermes-provider-adapter.ts`](../../../src/sdk/harnesses/hermes-provider-adapter.ts) (17 parity tests) + Phase 3 [`src/sdk/harnesses/opencode-provider-adapter.ts`](../../../src/sdk/harnesses/opencode-provider-adapter.ts) (18 parity tests, `finish-atomic` cancel semantics, workspace-root enforcement, JSON-stream CLI parsing); conformance suite still passes for all 8 reference providers; `engineer:verify` gate green; 1197 browser-first extension tests still pass |

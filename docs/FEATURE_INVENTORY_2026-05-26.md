...
- The Living Archive workspace can save a supported single text-like file directly to governed intake; unsupported files are blocked until a specialist attachment add-on handles them.

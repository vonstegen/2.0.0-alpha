...
- Promotion history can preview the promoted AI Memory markdown page through a scoped `AI_MEMORY/wiki` read route, so the user can inspect what actually became trusted memory without opening arbitrary files.

...
- [`PROPOSAL-resonant-extension-framework.md`](PROPOSAL-resonant-extension-framework.md) — framework proposal (draft for ADR-038)
...
- [`RESOLUTIONS_V0.1.md`](RESOLUTIONS_V0.1.md) — fork-author decisions on the conflicts, carried forward into ADR-038
...
during the design phase. On ADR-038 acceptance the proposal became

...
- Single-file text intake is available from the Living Archive workspace for supported text-like files (`.md`, `.txt`, `.csv`, `.json`). Unsupported media/binary files are blocked with guidance to use a specialist attachment add-on.
